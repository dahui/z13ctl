...
button input device for the daemon button watcher, and asus-armoury
firmware-attributes (boot sound, panel overdrive). Then reloads and triggers
...
This command must be run with sudo (unless --dry-run is used).`,
	RunE: func(_ *cobra.Command, _ []string) error {
		...
		fmt.Println("the Armoury Crate button, boot sound, and panel overdrive.")
